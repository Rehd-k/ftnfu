export function confirmationMail(email: any, confirmation_code: any) {
  return `<!DOCTYPE html>
<html
                                ...
                                >
                                  ...
                                  >
                                    <p style="margin: 0">
                                      ...
                                      your email. This ensures that you are who
                                      you say you are.
                                    </p>
                                  </div>
                                </td>
                            ...
                            >
                              <tr>
                                ...
                                >
                                  <div class="alignment" align="center">
                                    <!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://ftnfu.com/confirmation?email=${email}&id=${confirmation_code}" style="height:44px;width:107px;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#4D4997" fillcolor="#4d4997">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#ffffff;font-family:Tahoma, sans-serif;font-size:16px">
<!
                                    [endif]--><a
                                      href="https://ftnfu.com/confirmation?email=${email}&id=${confirmation_code}"
                                      target="_blank"
                                      style="
                              ...
                              <tr>
                                <td class="pad" style="width: 100%">
                                  <div
                                    ...
                                    style="line-height: 10px"
                                  >
                                    <div style="max-width: 201.667px">
                                      <img
                                        src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/8146/download_app.png"
                                        style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                            ...
                            >
                              <tr>
                                ...
                                >
                                  <div class="alignment" align="center">
                                    <!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:60px;width:298px;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#4D4997" fill="false">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
                            ...
                            >
                              <tr>
                                ...
                                >
                                  <div class="alignment" align="center">
                                    <!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://example.com" style="height:60px;width:298px;v-text-anchor:middle;" arcsize="0%" strokeweight="0.75pt" strokecolor="#4D4997" fill="false">
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#4d4997;font-family:Tahoma, sans-serif;font-size:16px">
<!
