          ...
          <Link href={menu.link} key={index}>
            <ListItem disablePadding>
              <ListItemButton>
                ...
                <p className="text-xs py-2 md:text-sm">{menu.title}</p>
              </ListItemButton>
            </ListItem>
          </Link>
        ))}
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: `var _smartsupp = _smartsupp || {};
                    _smartsupp.key = '6c5d26267ebfcb0dec5624ff8b677d62f8ceb255';
            ...
            <div className="flex justify-between w-full">
              <div className="flex">
                ...
                <Typography
                  component="p"
                  variant="inherit"
                  sx={{ mt: 1.5, display: { xs: "none", sm: "block" } }}
                >
              ...
              <button
                onClick={() => signOut()}
                className="bg-gray-300 dark:bg-gray-800 hover:bg-gray-400 text-white font-bold px-2 rounded-full border "
              >
