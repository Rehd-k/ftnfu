...
const validationSchema = yup.object({
  ...
  email: yup.string().required("Your Email Name is required"),
...
export default function FormReg() {
  ...
  const formIk = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      toast("Check you Mailbox to Confirm Your email and Continue");
    },
  });

  return (
    <form
      className="bg-white px-2 md:px-5 pb-10 h-screen md:h-full"
