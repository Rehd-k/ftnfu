    ...
    return <>
        <div className="h-screen dark:bg-gray-800 bg-gray-100 text-gray-500 dark:text-gray-200 px-5 md:text-md text-sm float-left w-full">
            ...
            <div className="mt-5">
                    ...
                    <>
                        ...
                        </div>
                        {
                            accounts.map((res, index) => {
                                ...
                                return <div className="bg-white dark:bg-gray-700 shadow rounded hover:shadow-md flex p-5 mt-5" key={index}>
                                    ...
                                    <div className="flex flex-wrap w-full md:ml-5 items-center text-xs md:text-sm">
                                        <div className="flex w-1/2 sm:w-1/4">
                                            ...
                                            <div className="flex-col w-full ml-1">
                                                <div className="font-semibold">{res.
                                                    accountType} - {res.accountNumber}</div>
                                                <div className="font-semibold">${res.startAmount}</div>
                                        ...
                                        <div className="flex-col md:text-center w-1/2 sm:w-1/4 text-right">
                                            ...
                                            <div className="mt-2.5 text-blue-900 dark:text-gray-500">${res.balance}</div>
                                        </div>
                ...
                <Link href={"/clientarea/trading-space"} className="bg-white dark:bg-gray-700 shadow rounded hover:shadow-md p-5 flex justify-center items-center mt-10">
                    <Add /> New Account
                                ...
                                return <div className="bg-white dark:bg-gray-700 shadow rounded hover:shadow-md flex p-5 mt-5" key={index}>
                                    ...
                                    <div className="flex flex-wrap w-full md:ml-5 items-center text-xs md:text-sm">
                                        ...
                                        <div className="flex-col text-center w-1/2 sm:w-1/4 mt-5 md:mt-0">
                                            ...
                                            <div className="mt-2.5 text-gray-300 dark:text-gray-500">
                                                {/* {
                                                    format(new Date(res.createdOn), 'LLLL d, yyyy')
                                                } */}
                                            </div>
                                        </div>
                                        <div className="w-1/2 sm:w-1/4 mt-5 md:mt-0 flex justify-end">
                                            <div className="w-full flex justify-end">
                                                Contact Customer Care to make Withdrawals
